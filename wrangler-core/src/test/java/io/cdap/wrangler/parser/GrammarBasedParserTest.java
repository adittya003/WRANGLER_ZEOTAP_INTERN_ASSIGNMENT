...
public class GrammarBasedParserTest {
  ...
  @Test
  public void testValidAggregateSyntax() throws Exception {
    String[] recipe = new String[] {
        "aggregate-sizeduration :data_transfer_size :response_time total_size_mb total_time_sec MB s avg;"
    };
    RecipeParser parser = TestingRig.parse(recipe);
    List<Directive> directives = parser.parse();
  ...
  public void testInvalidAggregateSyntax() throws Exception {
    String[] recipe = new String[] {
        "aggregate-sizeduration onlyOneColumn;"
    };
    RecipeParser parser = TestingRig.parse(recipe);
